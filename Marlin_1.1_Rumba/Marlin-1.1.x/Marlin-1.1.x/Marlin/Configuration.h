 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 102.2 } // Default***
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 161, 161, 400*1.014*2, 102.2*2 }
...
//
//#define REPRAPWORLD_GRAPHICAL_LCD NO ES
